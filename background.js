class Grass {
    constructor(game, x, y) {
        ...
        this.spritesheet = ASSET_MANAGER.getAsset("./sprites/tilesets/background.png");   
...
class WaterObjects {
    constructor(game, x, y) {
        Object.assign(this, { game, x, y});
        this.spritesheet = ASSET_MANAGER.getAsset("./sprites/objects/Water Objects.png");  
        // 144 0 16 16
        // 112 0
        // rocks 64 0 16 16
    ...
    draw(ctx) {
        // ctx.drawImage(this.spritesheet, 144, 0,
        //     16,  16,
        //     32,
        //     700,
        //     16 * 2,
        ...
        ctx.drawImage(this.spritesheet, 64, 0,
            32,  16,
            850,
            700,
            32 * 2,
            16 * 2);
        ctx.drawImage(this.spritesheet, 32, 0,
            16,  16,
            825,
            720,
            16 * 2,
            16 * 2);
        ctx.drawImage(this.spritesheet, 48, 0,
            16,  16,
            20,
            20,
            16 * 2,
